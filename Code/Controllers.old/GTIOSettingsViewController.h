...
@interface GTIOSettingsViewController : GTIOConcreteBackgroundTableViewController <TWTPickerDelegate, CustomUISwitchDelegate, RKObjectLoaderDelegate> {
    ...
    CustomUISwitch* _shareSuggestionsToFacebookSwitch;
}
