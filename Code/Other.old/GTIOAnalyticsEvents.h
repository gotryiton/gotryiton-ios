...
extern NSString* const kUserDidViewAddFromContactsEventName;
...
extern NSString* const kUserDidAddContactEventName;
extern NSString* const kUserDidRemoveContactEventName;
