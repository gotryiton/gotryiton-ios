...
typedef enum {
	...
	SSPullToLoadMoreViewStateNormal,
    
	/// Most will say "Release to refresh" in this state
	SSPullToLoadMoreViewStateReady,
    
	/// The view is loading
	SSPullToLoadMoreViewStateLoading,
    
	/// The view has finished loading and is animating
	SSPullToLoadMoreViewStateClosing
} SSPullToLoadMoreViewState;

@protocol SSPullToLoadMoreViewDelegate;
@protocol SSPullToLoadMoreContentView;

@interface SSPullToLoadMoreView : UIView
 ...
 */
@property (nonatomic, strong) UIView<SSPullToLoadMoreContentView> *contentView;
 ...
 */
@property (nonatomic, assign) id<SSPullToLoadMoreViewDelegate> delegate;
...
@protocol SSPullToLoadMoreViewDelegate <NSObject>
 ...
 */
- (BOOL)pullToLoadMoreViewShouldStartLoading:(SSPullToLoadMoreView *)view;
 ...
 */
- (void)pullToLoadMoreViewDidFinishLoading:(SSPullToLoadMoreView *)view;
 ...
 */
- (NSDate *)pullToLoadMoreViewLastUpdatedAt:(SSPullToLoadMoreView *)view;

@end


@protocol SSPullToLoadMoreContentView <NSObject>
 ...
 */
- (void)setLastUpdatedAt:(NSDate *)date withPullToRefreshView:(SSPullToLoadMoreView *)view;
