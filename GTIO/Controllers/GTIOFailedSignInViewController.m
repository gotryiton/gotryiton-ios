...
@property (nonatomic, strong) GTIOUIButton *tryAgainButton;
@property (nonatomic, strong) GTIOUIButton *createUserButton;
@property (nonatomic, strong) GTIOUIButton *emailSupportButton;
...
- (void)viewDidLoad
{
    ...
    self.tryAgainButton = [GTIOUIButton buttonWithGTIOType:GTIOButtonTypeTryAgain];
    ...
    self.createUserButton = [GTIOUIButton buttonWithGTIOType:GTIOButtonTypeNewUser];
    ...
    self.emailSupportButton = [GTIOUIButton buttonWithGTIOType:GTIOButtonTypeEmailSupport];
